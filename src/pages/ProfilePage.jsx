import React, { useState, useEffect, useRef, useContext } from 'react'; //импорт реакта и трех хуков для памяти, побочных эффектов и ссылки
  ...
  //загрузка профиля
   useEffect(() => {
    if (user) {
      ...
      // Если пользователь не загружен, пробуем загрузить
      loadUser().then(() => {
        setLoading(false);
      }).catch(() => {
